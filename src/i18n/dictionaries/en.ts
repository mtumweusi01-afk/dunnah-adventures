...
const en: Dictionary = {
  ...
  common: {
    ...
    days: "days",
    allGroupSizes: "Private, small & large groups",
  },
  home: {
    ...
    testimonialsTitle: "What travellers say",
    testimonials: [
      {
        quote:
          "Our guide spotted a leopard from half a kilometre away. Every day of the safari felt like a privilege.",
        author: "Placeholder review — swap for a real guest quote",
      },
      {
        quote:
          "Effortless planning from the first WhatsApp message to the airport pickup. Highly recommend.",
        author: "Placeholder review — swap for a real guest quote",
      },
      {
        quote:
          "The Mara-to-Diani combo was the trip of a lifetime. Perfectly paced, never rushed.",
        author: "Placeholder review — swap for a real guest quote",
      },
    ],
    ctaTitle: "Ready to see Kenya?",
    ctaSubtitle:
      "Tell us what you're dreaming of and we'll build an itinerary around it.",
  ...
  destinations: {
    ...
    title: "Destinations",
    subtitle: "The places that make Kenya safaris legendary.",
  ...
  blog: {
    ...
    subtitle: "Practical advice for planning your Kenya trip.",
  },
  contact: {
    eyebrow: "Get in touch",
    title: "Plan Your Trip",
    subtitle:
      "Tell us a little about the trip you have in mind and we'll get back to you personally.",
    formNameLabel: "Full name",
    formEmailLabel: "Email address",
    formPhoneLabel: "Phone / WhatsApp",
    formTourLabel: "Interested in",
